...
import 'package:only_believe/pages/hymn_screen3.dart';
...
class NyimboZaoKovu extends StatefulWidget {
  const NyimboZaoKovu({Key key,}) : super(key: key);

  @override
  _NyimboZaoKovu createState() => _NyimboZaoKovu();

}

class _NyimboZaoKovu extends State<NyimboZaoKovu> {
      ...
      body: Column(
        children: <Widget>[
          Expanded(
                child: Container(
                   child: FutureBuilder(
                     future: dbAllHymns.getNyimboList(),
