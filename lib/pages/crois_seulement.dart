...
import 'package:only_believe/pages/hymn_screen2.dart';
...
class CroisSeulement extends StatefulWidget {
  const CroisSeulement({Key key,}) : super(key: key);

  @override
  _CroisSeulement createState() => _CroisSeulement();

}

class _CroisSeulement extends State<CroisSeulement> {
      ...
      body: Column(
        children: <Widget>[
          Expanded(
                child: Container(
                   child: FutureBuilder(
                     future: dbAllHymns.getCroiSeulementList(),
